...
export default function CartPage() {
  ...
  return (
    ...
    <>
      ...
      <div className="flex flex-col max-w-[40rem] px-3 pb-3">
        <div className="border-2 px-3 pb-2 bg-[#171717]">
          <div className="border-b-4 py-8">
            <Heading className="pl-7 ">Order Summary</Heading>
          </div>
          <div className="flex flex-col gap-3 px-8 border-b-4 py-12">
            <div className="flex justify-between">
              <Text className="">Subtotal</Text>
              <Text className="w-10">{totalPrice}</Text>
            </div>
            <div className="flex justify-between">
          ...
          {show ? 
          <Link to="/checkout" className="w-full py-4 bg-green-500  font-semibold text-center text-black">Checkout</Link>
          : null}
          <Link to="/productlist" className="w-full py-4 bg-red-500 font-semibold mt-4 text-center text-black">Continue Shopping</Link>
        </div>
      </div>
        </div>
      </div>

...
function Signup() {
  ...
  return (
    <form onSubmit={handleSubmit(SignUp)} className="text-black rounded-lg border bg-card text-card-foreground shadow-sm p-4 px-12"><div className="flex flex-col p-6 space-y-1"><h3 className="text-white font-semibold tracking-tight text-2xl">Create an account</h3></div><div className="p-6 px-0 pt-0 grid gap-4"><div className="grid gap-2">
